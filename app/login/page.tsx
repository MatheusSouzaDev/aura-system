      ...
      <div className="relative z-10 flex w-full flex-1 items-center justify-center px-6 py-10 sm:px-10 lg:px-16 lg:py-0">
        ...
        >
          ...
          <p className="mb-10 text-base text-white/80 sm:text-lg">
            A Aura System AI � uma plataforma de gest�o financeira que utiliza
            IA para monitorar suas movimenta��es e oferecer insights
            personalizados, facilitando o controle do seu or�amento.
          </p>
          <SignInButton>
            <Button
              variant="ghost"
